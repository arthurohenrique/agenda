...
export default function ErrorPage({
  ...
  useEffect(() => {
    if (!error.digest) console.error("Unhandled client application error");
  }, [error]);

  return (
    <main className="grid min-h-screen place-items-center bg-zinc-50 p-6" id="main-content" tabIndex={-1}>
